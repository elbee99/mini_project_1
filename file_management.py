...
base_folder = r"C:\Users\lb958\Data\2023_01_25_Cu_120C\maps"
...
for i in range(12): #number of measurements is 50
    ...
    for j in range(1,41): #as there are 40 files per measurement
        file_number = (i*40)+j
        if file_number <= 9:
            file_name = "Cu_Tile_120C_map_20230125-131101_00{}.png".format(file_number)
        elif file_number <= 99:
            file_name = "Cu_Tile_120C_map_20230125-131101_0{}.png".format(file_number)
        else:
            file_name = "Cu_Tile_120C_map_20230125-131101_{}.png".format(file_number)
